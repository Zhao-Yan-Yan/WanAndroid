...
object ExceptionHandle {
    ...
    fun handleException(e: Throwable): NetException {
        return when (e) {
            ...
            is JsonParseException, is JSONException, is ParseException, is MalformedJsonException -> NetException(NetError.PARSE_ERROR)
            is ConnectException -> NetException(NetError.NETWORK_ERROR)
            is SSLException -> NetException(NetError.SSL_ERROR)
            is ConnectTimeoutException, is SocketTimeoutException, is UnknownHostException -> NetException(NetError.TIMEOUT_ERROR)
